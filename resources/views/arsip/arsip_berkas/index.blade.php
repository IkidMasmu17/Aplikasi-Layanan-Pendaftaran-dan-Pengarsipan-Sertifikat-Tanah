...
<div class="content-wrapper">
    <div class="content p-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button data-id="{{$d->id}}" data-nama="{{$d->user->nama}}"
                                            data-fisik="{{$d->no_fisik}}" type="button" class="btn btn-sm btn-primary tambah-arsip"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button data-id="{{$d->id}}" data-nama="{{$d->user->nama}}"
                                            data-fisik="{{$d->no_fisik}}" type="button" class="btn btn-sm btn-primary tambah-sertifikat"
        ...
        @section('script')
        <script>
            $('.tambah-arsip').on('click',function(e){
                var id = $(this).data('id');
                var nama = $(this).data('nama');
                var fisik = $(this).data('fisik');

                $('#nama_pemohon').text(nama);
                $('#nomor_fisik').text(fisik);
                $('#permohonan_id').val(id);


            });

            $('.tambah-sertifikat').on('click',function(e){
                var id = $(this).data('id');
                var nama = $(this).data('nama');
                var fisik = $(this).data('fisik');

                $('#nama_pemohons').text(nama);
                $('#nomor_fisiks').text(fisik);
                $('#permohonan_ids').val(id);
